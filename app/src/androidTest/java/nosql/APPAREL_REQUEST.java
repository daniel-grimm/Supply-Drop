/**This class allows for an apparel request to be made from the application.
 * @author Daniel Grimm
 *
 * Some code snippets have been automatically generated by Amazon Web Services and are being used in
 * this application.*/
